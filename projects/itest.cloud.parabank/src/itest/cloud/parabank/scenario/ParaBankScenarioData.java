 ...
 * </p>
 */
public class ParaBankScenarioData extends ScenarioData implements ParaBankScenarioConstants {

public ParaBankScenarioData() {
	super();
}

@Override
protected void initUsers() {
	this.testUser = new ParaBankUser("tester");
}
}