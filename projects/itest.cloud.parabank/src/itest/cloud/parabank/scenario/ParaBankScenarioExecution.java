 ...
 */
public class ParaBankScenarioExecution extends ScenarioExecution {
...
public ParaBankScenarioExecution() {
	super();
    this.delay= getParameterIntValue(ParaBankConstants.STEP_DELAY_ID);
 ...
 * {@inheritDoc}
 *
 * @return The Bluemix scenario configuration as {@link ParaBankConfig}.
 */
@Override
 ...
 * {@inheritDoc}
 *
 * @return the scenario data as a {@link ParaBankScenarioData}.
 */
@Override
public ParaBankScenarioData getData() {
	return (ParaBankScenarioData) super.getData();
}

/**
 * {@inheritDoc}
 *
 * @return The Bluemix scenario topology as {@link ParaBankTopology}.
 */
@Override
...
protected void initConfig() {
	this.config = new ParaBankConfig();
}

@Override
protected void initData() {
	this.data = new ParaBankScenarioData();
}
