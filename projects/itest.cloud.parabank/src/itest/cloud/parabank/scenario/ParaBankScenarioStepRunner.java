 ...
 * </p>
 */
public class ParaBankScenarioStepRunner extends ScenarioStepRunner {
...
public ParaBankScenarioStepRunner(final Class< ? > klass) throws InitializationError {
	super(klass);
...
protected void startExecution() {
	this.scenarioExecution = new ParaBankScenarioExecution();
}
