 ...
 */
abstract public class ParaBankScenarioRunner extends ScenarioRunner implements ParaBankScenarioConstants {

public ParaBankScenarioRunner(final Class< ? > klass, final RunnerBuilder builder) throws InitializationError {
	super(klass, builder);
}
 ...
 *
 * @return The data as a {@link ParaBankScenarioData}.
 */
protected ParaBankScenarioData getScenarioData(){
	return getScenarioExecution().getData();
}

@Override
public ParaBankScenarioExecution getScenarioExecution() {
	return (ParaBankScenarioExecution) super.getScenarioExecution();
}
