 ...
 * </p>
 */
public class ParaBankSelectionElement extends SelectionElement {
...
public ParaBankSelectionElement(final ElementWrapper parent, final By labelElementLocator) {
...
public ParaBankSelectionElement(final ElementWrapper parent, final String forAttributeValue) {
	this(parent, getLabelElementLocator(forAttributeValue, true /*isRelative*/));
}

public ParaBankSelectionElement(final ElementWrapper parent, final BrowserElement labelElement) {
	this(parent, labelElement.waitForElement(INPUT_ELEMENT_LOCATOR, false /*displayed*/), labelElement);
}

public ParaBankSelectionElement(final ElementWrapper parent, final BrowserElement element, final BrowserElement labelElement) {
	super(parent, element, labelElement);
}

public ParaBankSelectionElement(final Page page, final By labelElementLocator) {
	super(page, null /*element*/);
	this.labelElement = page.waitForElement(labelElementLocator);
	this.element = this.labelElement.waitForElement(INPUT_ELEMENT_LOCATOR, false /*displayed*/);
}

public ParaBankSelectionElement(final Page page, final String forAttributeValue) {
	this(page, getLabelElementLocator(forAttributeValue, false /*isRelative*/));
}

public ParaBankSelectionElement(final Page page, final BrowserElement labelElement) {
	this(page, labelElement.waitForElement(INPUT_ELEMENT_LOCATOR, false /*displayed*/), labelElement);
}

public ParaBankSelectionElement(final Page page, final BrowserElement element, final BrowserElement labelElement) {
