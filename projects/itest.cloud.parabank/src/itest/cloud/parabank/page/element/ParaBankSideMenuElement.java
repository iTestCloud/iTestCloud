...
/**
 * This class represents and manages the side menu element of a web page {@link ParaBankPage}.
 * <p>
 ...
 * </p>
 */
public class ParaBankSideMenuElement extends ParaBankExpandableElement {

	private ParaBankSideMenuTreeElement sideMenuTreeElement;

public ParaBankSideMenuElement(final Page page) {
	super(page, By.id("dap-side-menu"), By.id("sidemenu-toggle-button"));
	this.sideMenuTreeElement = new ParaBankSideMenuTreeElement(this);
}
