 ...
 * </p>
 */
public abstract class ParaBankTabElement extends TabElement {
 ...
 * otherwise.
 */
public ParaBankTabElement(final ElementWrapper parent, final By findBy) {
	super(parent, findBy);
}
 ...
 */
public ParaBankTabElement(final ElementWrapper parent, final By findBy, final String... data) {
 ...
 */
public ParaBankTabElement(final Page page) {
 ...
 * otherwise.
 */
public ParaBankTabElement(final Page page, final By findBy) {
	super(page, findBy);
}
 ...
 * on the other hand, then it should be hard-coded in {@link #getExpectedTitle()} method.
 */
public ParaBankTabElement(final Page page, final By findBy, final String... data) {
