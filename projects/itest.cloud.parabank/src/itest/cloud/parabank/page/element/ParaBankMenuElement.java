 ...
 * Select a specific item (option) from the menu element by opening a {@link ParaBankPage}.</li>
 * </ul>
 * </p><p>
 ...
 * </p>
 */
public abstract class ParaBankMenuElement extends ParaBankExpandableElement {

public ParaBankMenuElement(final Page page, final By findBy, final By expansionLocator) {
	super(page, findBy, expansionLocator);
}

public ParaBankMenuElement(final Page page, final BrowserElement webElement, final By expansionLocator) {
...
public <T extends ParaBankPage> T select(final String item, final Class<T> pageClass) {
 ...
 * @return The opened confirmation dialog as a subclass of {@link ParaBankPage}.
 */
@SuppressWarnings("unchecked")
public <T extends ParaBankPage> T select(final String item, final Class<T> pageClass, final boolean force) {
