 ...
 * </p>
 */
public class ParaBankTabListElement extends TabListElement {

public ParaBankTabListElement(final ElementWrapper parent, final BrowserElement element, final By openLinkLocator) {
	super(parent, element, openLinkLocator);
}

public ParaBankTabListElement(final ElementWrapper parent, final By locator, final By openLinkLocator) {
	super(parent, locator, openLinkLocator);
}

public ParaBankTabListElement(final Page page, final BrowserElement element, final By openLinkLocator) {
	super(page, element, openLinkLocator);
}

public ParaBankTabListElement(final Page page, final By locator, final By openLinkLocator) {
	super(page, locator, openLinkLocator);
}

public ParaBankTabListElement(final Page page) {
