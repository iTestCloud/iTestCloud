 ...
 * </p>
 */
public class ParaBankAlertElement extends AlertElement {
...
public ParaBankAlertElement(final Page page, final BrowserElement element) {
	super(page, element, null /*messageElementLocator*/, null /*statusElementLocator*/, CLOSE_BUTTON_LOCATOR);
}

public ParaBankAlertElement(final Page page, final By findBy) {
