 ...
 * </p>
 */
public class ParaBankTreeNodeElement extends TreeNodeElement {

public ParaBankTreeNodeElement(final ElementWrapper parent, final By locator, final By labelBy, final By expansionBy, final By childrenBy) {
	super(parent, locator, labelBy, expansionBy, childrenBy);
}

public ParaBankTreeNodeElement(final ElementWrapper parent, final BrowserElement webElement, final By labelBy, final By expansionBy, final By childrenBy) {
	super(parent, webElement, labelBy, expansionBy, childrenBy);
}

public ParaBankTreeNodeElement(final Page page, final By locator, final By labelBy, final By expansionBy, final By childrenBy) {
	super(page, locator, labelBy, expansionBy, childrenBy);
}

public ParaBankTreeNodeElement(final Page page, final BrowserElement webElement, final By labelBy, final By expansionBy, final By childrenBy) {
