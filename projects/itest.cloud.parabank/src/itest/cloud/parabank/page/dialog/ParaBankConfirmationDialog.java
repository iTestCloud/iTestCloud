 ...
 *********************************************************************/
package itest.cloud.parabank.page.dialog;

import static itest.cloud.parabank.scenario.ParaBankScenarioConstants.*;
...
/**
 * This class represents a generic confirmation dialog in an IBM application and manages all its common actions.
 * <p>
 ...
 * </p>
 */
public abstract class ParaBankConfirmationDialog extends ConfirmationDialog {

public ParaBankConfirmationDialog(final Page page) {
	super(page, DIALOG_LOCATOR);
}

public ParaBankConfirmationDialog(final Page page, final String... data) {
