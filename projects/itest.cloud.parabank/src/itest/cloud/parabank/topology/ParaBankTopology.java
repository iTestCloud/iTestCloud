 ...
 *********************************************************************/
package itest.cloud.parabank.topology;

import static itest.cloud.parabank.topology.ParaBankTopology.ApplicationInfo.PARA_BANK;
...
import itest.cloud.parabank.config.ParaBankConstants;
...
/**
 * Class to manage the Para Bank topology.
 * <p>
 ...
 * <li>{@link #getParaBankApplication()}: Returns the Cognos Analytics application.</li>
 ...
 * </p>
 */
public class ParaBankTopology extends Topology implements ParaBankConstants {
	/**
	 * Enumeration of possible applications which can be added to the current topology.
	 */
	public enum ApplicationInfo {
		PARA_BANK(ParaBankApplication.class);
		...
		static ApplicationInfo fromId(final String id) {
			...
			throw new ScenarioFailedError("Cannot find information for application ID '" + id + "'");
		}
 ...
 *
 * @return The application as an {@link Application}.
 */
...
/**
 * Returns the Para Bank application.
 *
 * @return The Para Bank application as {@link ParaBankApplication}.
 */
public ParaBankApplication getParaBankApplication() {
	return (ParaBankApplication) getApplicationFromName(PARA_BANK.name());
}
...
//		final String appUrl = (applicationInfo == PARA_BANK_MOBILE) ? MOBILE_APPLICATION_URL : appInfo[1];
		final String appUrl = appInfo[1];
