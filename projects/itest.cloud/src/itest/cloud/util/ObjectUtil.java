 ...
 * <pre>
 * public Foo(Bar bar, Baz baz) {
 *     this.bar = ObjectUtil.requireNonNull(bar, new AssertionFailedError("bar must not be null."));
 *     this.baz = ObjectUtil.requireNonNull(baz, new AssertionFailedError("baz must not be null."));
 * }
 * </pre>
 *
 * @param object The object reference to check for nullity.
