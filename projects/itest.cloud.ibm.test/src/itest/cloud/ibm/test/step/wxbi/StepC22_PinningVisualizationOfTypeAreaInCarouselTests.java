...
import static itest.cloud.ibm.entity.wxbi.conversation.WxbiVisualizationType.AREA;
...
/**
 * This class defines a set of tests on pinning Area type visualizations in the carousel.
 * <p>
...
public class StepC22_PinningVisualizationOfTypeAreaInCarouselTests extends StepXX_PinningVisualizationInCarouselTests {
...
protected String getChartGenerationQuery() {
	return QUERY_PLANNED_REVENUE_TREND_BY_YEAR;
}
}