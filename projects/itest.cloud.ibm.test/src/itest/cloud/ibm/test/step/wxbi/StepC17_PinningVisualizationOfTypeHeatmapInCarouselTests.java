...
import static itest.cloud.ibm.entity.wxbi.conversation.WxbiVisualizationType.HEATMAP;
...
/**
 * This class defines a set of tests on pinning Heatmap type visualizations in the carousel.
 * <p>
...
public class StepC17_PinningVisualizationOfTypeHeatmapInCarouselTests extends StepXX_PinningVisualizationInCarouselTests {
...
protected String getChartGenerationQuery() {
	return QUERY_TOTAL_REVENUE_GENERATED_BY_EACH_PRODUCT_TYPE_IN_EACH_MONTH;
}
}