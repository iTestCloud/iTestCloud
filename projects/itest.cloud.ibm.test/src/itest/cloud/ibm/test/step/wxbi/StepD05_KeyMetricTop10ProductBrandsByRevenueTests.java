...
/**
 * This class defines a set of tests for validating various aspects of the key metric 'Top 10 product brands by revenue'.
 * <p>
...
protected String getKeyMetricName() {
	return "Top 10 product brands by revenue";
}
}