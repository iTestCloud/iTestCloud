...
public class Step01_BoardTests extends CaMobileScenarioStep {
	...
	private static final String BOARD2 = "Automation Board 2";
...
public void test05_OpenCallsResolvedChartInBoard2() {
	openChartInBoard(BOARD2, "Calls Resolved", getTestUser());
}
...
public void test06_OpenAvgCostCallChartInBoard2() {
	openChartInBoard(BOARD2, "AVG Cost/Call", getTestUser());
}
