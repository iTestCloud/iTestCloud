...
/**
 * This class defines a set of tests for validating various aspects of the key metric 'Product revenue share'.
 * <p>
...
public class StepD06_KeyMetricProductRevenueShareTests extends StepXX_DefaultKeyMetricTests {

@Override
protected String getKeyMetricName() {
	return "Product revenue share";
}
}