...
import static itest.cloud.ibm.entity.wxbi.conversation.WxbiVisualizationType.PACKED_BUBBLE;
...
/**
 * This class defines a set of tests on pinning Packed Bubble type visualizations in the carousel.
 * <p>
...
public class StepC06_PinningVisualizationOfTypePackedBubbleInCarouselTests extends StepXX_PinningVisualizationInCarouselTests {

@Override
protected WxbiVisualizationType getVisualizationType() {
	return PACKED_BUBBLE;
}

@Override
protected String getChartGenerationQuery() {
	return QUERY_REVENUE_BY_PRODUCT_LINE;
}
}