...
import static itest.cloud.ibm.entity.wxbi.conversation.WxbiVisualizationType.COLUMN_STACKED;
...
/**
 * This class defines a set of tests on pinning Column Stacked type visualizations in the carousel.
 * <p>
...
public class StepC10_PinningVisualizationOfTypeColumnStackedInCarouselTests extends StepXX_PinningVisualizationInCarouselTests {
...
protected String getChartGenerationQuery() {
	return QUERY_REVENUE_COMPARED_TO_PLANNED_REVENUE_BY_PRODUCT_LINE;
}
}